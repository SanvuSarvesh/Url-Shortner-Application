...
import com.example.UrlShortner.exception.apiError.ApiError;
...
//    @Override
    ...
    @ExceptionHandler(UrlExceptions.class)
    protected ResponseEntity<Object> handleM3AdaptorUtilException(UrlExceptions ex) {
        ApiError apiError;
